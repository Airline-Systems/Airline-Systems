...
def Default():
    return 'Please provide a flight number.'



@app.route('/<flight_number>', methods=['GET'])
def airlineOptimizer(flight_number, occupancy=170, occupancy2=167):
    #outbound flight
    flight_number1 = int(flight_number)
    ...
    return jsonify({'outbound_flight':{
